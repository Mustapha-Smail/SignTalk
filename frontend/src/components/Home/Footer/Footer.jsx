...
const Footer = () => (
  <div className="st__footer section__padding">
    ...
    <div className="st__footer-links">
     ...
     <br></br>
        <p> SignTalk est une application d'apprentissage de langue de signe Française.
          Créer par des étudiants MIAGE Nanterre qui sera un guide pour vous aider à vous épanouir linguistiquement!
        </p>
