...
* Diagramme de la feature de memory

image:Diagram-memory.png[Diagram_memory,300,300]

* Diagramme de la feature de classement

image:Diagram-classement.png[Diagram_classement,300,300]

* Diagramme de la feature du pendu

image:Diagram-historique_badge.png[Diagram_pendu,300,300]
