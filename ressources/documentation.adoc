...
image:Diagram.png[Wireframe_decomposition,300,300]

* Diagramme de la feature 4 images un mot

image:Diagram-QuizA.png[Wireframe_decomposition,300,300]

* Diagramme de la feature 1 images 4 mot

image:Diagram-Quiz2.png[Wireframe_decomposition,300,300]

* Diagramme de la feature de recherche

image:Diagram-recherche.png[Wireframe_decomposition,300,300]

* Diagramme de la feature de decomposition

image:Diagram-decomposition.png[Wireframe_decomposition,300,300]
...
image:Diagramme-de-classes.png[Wireframe_decomposition,300,300]